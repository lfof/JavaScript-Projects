...
const Calculator = {
    ...
    First_Operand: null,
    //This checks wheter or not the second operand has been inputtd by the user.
    Wait_Second_Operand: false,
    //This will bold the operator, we set it to null for now.
    operator: null,
};

//This modiifes values each time a button is clicked on.
...
function Input_Decimal(dot) {
    //This ensures that accidental click of the decimal point doesn't
...
function Handle_Operator(Next_Operator) {
    ...
    //When and operator key is pressed we conver the current number
...
keys.addEventListener('click', (event) => {
    ...
    //Ensures thet AC clears all inputs from the Calculator screen.
